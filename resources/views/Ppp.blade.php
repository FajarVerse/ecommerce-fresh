                                    ...
                                    {{-- ($products as $product) --}}
                                        <tr>
                                            <td>
                                                <div class="d-flex px-2 py-1">
                                                    <div>
                                                        <img src="{{ $product->image ? asset('storage/' . $product->image) : '../assets/img/default-product.jpg' }}"
                                            ...
                                            <td class="align-middle text-center text-sm">
                                                <span class="badge badge-sm" style="background-color: {{ $product->stock > 0 ? '#2dce89' : '#fb6340' }}">{{ $product->stock }}</span>
                                            </td>
                                            <td class="align-middle text-center text-sm">
                                                <span class="badge badge-sm bg-gradient-{{ $product->status == 'active' ? 'success' : 'danger' }}">{{ $product->status == 'active' ? 'Aktif' : 'Tidak Aktif' }}</span>
                                            </td>
                                            <td class="align-middle">
                                                <a href="#"
                                                    class="text-secondary font-weight-bold text-xs"
