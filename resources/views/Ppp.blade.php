...
<tr>
    ...
    <td class="align-middle text-center text-sm">
        <span class="badge badge-sm"
            style="background-color: {{ $product->stock > 0 ? '#2dce89' : '#fb6340' }}">{{ $product->stock }}</span>
    </td>
    <td class="align-middle text-center text-sm">
        <span
            class="badge badge-sm bg-gradient-{{ $product->status == 'active' ? 'success' : 'danger' }}">{{ $product->status == 'active' ? 'Aktif' : 'Tidak Aktif' }}</span>
    </td>
    <td class="align-middle">
