...
<div class="container-fluid page-header py-5 position-relative" 
   ...
   <div style="position:relative; z-index:2;" class="text-center">
        <h1 class="display-6 fw-bold text-white">Shop Detail</h1>
                        ...
                        <div class="row g-4">
                            <div class="col-lg-6">
                                <div class="border rounded">
                                    <a href="#">
                                        <img src="{{ Vite::asset('resources/img/product_img/apel.jpg') }}"  class="img-fluid rounded w-100 h-100" alt="" style="max-height: 300px; object-fit: cover;">
                                    </a>
                                </div>
                            </div>
                            <div class="col-lg-6">
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="d-flex align-items-center justify-content-start">
                                    ...
                                    <div>
                                        ...
                                        <div class="d-flex mb-2">
                                            <h5 class="fw-bold me-2">{{ $product->harga }}</h5>
  ...
  function updateCartTotals() {
    ...
    document.getElementById("grand-total").textContent = `$${(subtotal + (subtotal > 0 ? shippingCost : 0)).toFixed(2)}`;
  }
