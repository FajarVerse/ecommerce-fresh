                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        <tr>
                                            <th scope="row">
                                                <div class="d-flex align-items-center mt-2">
                                                     <img src="{{ Vite::asset('resources/img/product_img/apel.jpg') }}" alt="" class="img-fluid rounded-circle" style="width: 90px; height: 90px;" alt="">
                                                    </div>
                                            </th>
                                        ...
                                        <tr>
                                            <th scope="row">
                                                <div class="d-flex align-items-center mt-2">
                                                     <img src="{{ Vite::asset('resources/img/product_img/apel.jpg') }}" alt="" class="img-fluid rounded-circle" style="width: 90px; height: 90px;" alt=""></div>
                                            </th>
