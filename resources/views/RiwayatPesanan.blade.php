<x-layout>
    ...
    <style>
        ...
        .status-processed { background-color: #d1e7dd; color: #0f5132; }
    ...
    <body class="min-h-screen bg-gray-100 flex flex-col">
        ...
        <div class="container mx-auto p-6 pt-10 flex-grow">
            ...
            <div class="mt-8 text-center">
                <a href="/" class="custom-green font-bold px-6 py-3 rounded-lg text-center hover:bg-green-700 transition-colors">
